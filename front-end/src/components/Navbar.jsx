export default function Navbar({ pageTitle = "แดชบอร์ด", userName = "Guest", userRole = "User" }) {
  ...
  return (
    <nav className="flex items-center justify-between px-6 h-14 bg-yellow-50 border-b border-yellow-200">
      ...
      <div className="flex items-center gap-2">
        ...
        {/* ตะกร้า */}
        <div className="relative flex items-center justify-center w-9 h-9 cursor-pointer">
